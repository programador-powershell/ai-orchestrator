...
const directory = mkdtempSync(join(tmpdir(), "ai-bot-release-"));
...
const result = spawnSync(process.execPath, [
  ...
  "--publisher", "AI-BOT Test Publisher", "--desktop", desktop,
...
if (parsed.product !== "AI-BOT" || parsed.components[0].size !== 22) throw new Error("release payload contract mismatch");
...
const manifestOnlyDirectory = mkdtempSync(join(tmpdir(), "ai-bot-bootstrapper-"));
