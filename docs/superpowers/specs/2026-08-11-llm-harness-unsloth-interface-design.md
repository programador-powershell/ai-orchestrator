...
O AI-BOT embute clones completos de terceiros (`third_party/`: soup,
...
- `next.config.ts`: `output: 'export'`, `images.unoptimized: true`,
  `transpilePackages: ['@ai-bot/contracts']`, `reactStrictMode: true`.
...
- **Política AI-BOT (item 4):** submeter a TI/SI o uso do unsloth como
