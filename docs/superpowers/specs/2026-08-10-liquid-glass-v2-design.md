...
| Work | Kanban + automações (receitas) + conectores Microsoft 365 (somente conectores aprovados, conta corporativa — política Multiplike refletida na copy) | Superior ao cowork: integrações declaradas, tarefas automatizáveis |
...
| Segredos | Chaves só no gateway ou keyring nativo (comando existente); nunca em localStorage; copy orienta cofre corporativo | Política Multiplike |
